		...
		<div className="container">
			...
			<div className="row py-5 bg-white">
				...
				<div className="col-12 col-md-7">
					<p className="lead">
						Una escalera de 10 pies de largo está apoyada contra un muro vertical. Si la parte
						inferior de la escalera se desliza alejándose de la pared en una proporción de 1
						pie/s.
					</p>
				...
				<div class="collapse" id="collapseExplicacion">
					<div class="card card-body">
						<p>
							...
							<br />
							<br />
							Primero dibuja un esquema y anota los datos como se muestra en la figura 1.3.
							Sea x pies la distancia desde la parte inferior de la escalera al muro y y pies
							la distancia desde la parte superior de la escalera al piso. Observe que x y y
							son funciones del tiempo t (tiempo que se mide en segundos).
							<br />
							<br />
							<b>b. Analizar el problema</b>
							<br />
							<br />
							Se sabe que dx/dt = 1/pies y se pide determinar dy/dt cuando x=6 pies
							<br />
							<br />
							...
							Al derivar con respecto a t ambos miembros en (1) aplicando la regla de la
							cadena
							<div className="explication__badge">
							...
							Cuando x = 6, el teorema de Pitágoras da y = 8 y al sustituir estos valores en
							(3) y considerando que dx/dt = 1, llega a…
							<br />
							<br />
							<button
							...
							<div class="collapse" id="collapseRespuesta">
								<div className="card-body">
									...
									El hecho de que dy/dt sea negativa quiere decir que la distancia desde la
									parte superior de la escalera al suelo decrece una proporción de 3/4
									pies/s.
									<br />
									<br />
									La parte superior de la escalera se resbala hacia debajo de la pared una
									proporción de 3/4 pies/s.
								</div>
							</div>
							<br />
							<br />
				...
				<div class="collapse" id="collapsePista">
					<div class="card card-body">
						<ul className="list-group">
							<li className="list-group-item">Considerar el teorema de Pitágoras</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div className="d-flex justify-content-end">
				<Link to="/el-cono">
					<img src={next} alt="" className="icon icon-next" />
				</Link>
			</div>
		</div>
  );
