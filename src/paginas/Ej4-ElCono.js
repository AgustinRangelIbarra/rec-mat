		...
		<div className="container">
			...
			<div className="row py-5 bg-white">
				...
				<div className="col-12 col-md-7">
					<p className="lead">
						Un depósito para agua tiene la forma de un cono circular invertido, el radio de la
						base es de 2 m, y la altura es de 4 m. Si el agua se bombea hacia el depósito a
						una razón de 2m3/min.
					</p>
				...
				<div class="collapse" id="collapseExplicacion">
					<div class="card card-body">
						<p>
							...
							<br />
							<br />
							Primero elabore un diagrama del cono y anote la información como en la figura
							1.5. Sean V, r y h el volumen del agua, el radio de la superficie circular y la
							altura en el tiempo t, respectivamente, donde t se mide en minutos.
							<br />
							<br />
							<b>b. Analizar el problema</b>
							<br />
							<br />
							Se sabe que dVdt=2m3min y se pide determinar dhdt cuando h es 3 m. Las
							cantidades V y h se relacionan mediante la ecuación (1)
							<br />
							...
							<br />
							<br />
							Pero es muy útil expresar V sólo en función de h. Con objeto de eliminar r,
							recurra a los triángulos semejantes en la figura 1.5 para escribir:
							<div className="explication__badge">
								<i>rh=24 r=h2 ……………(2)</i>
							</div>
							...
							<div class="collapse" id="collapseRespuesta">
								<div className="card-body">
									<div className="explication__badge">
										<i>
											La rapidez a la cual el nivel del agua sube cuando el agua tiene 3
											m. de profundidad es de 0.2829 m3/min
										</i>
									</div>
								</div>
							</div>
