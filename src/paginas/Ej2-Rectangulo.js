		...
		<div className="container">
			<div className="row py-3 py-mb-5 jumbotron">
				<main className="col-12 col-md-12">
					...
					<p className="instrucciones">
						El siguiente ejercicio es acerca de la velocidad con la que crece el área de un
						rectángulo…
			...
			<div className="row py-5 bg-white">
				...
				<div className="col-12 col-md-7">
					<p className="lead">
						Considere que un rectángulo incrementa su tamaño a razón de 8 cm/seg y el ancho en
						3 cm/seg.
					</p>
					<p className="lead">
						<b>
