		...
		<div className="container">
			...
			<div className="row py-5 bg-white">
				...
				<div className="col-12 col-md-7">
					<p className="lead">
						Al arrojar una piedra a un estanque de agua tranquila se forman ondas circulares
						concéntricas cuyos radios aumentan de longitud al paso del tiempo.
					</p>
					<p className="lead">
						<b>
							Cuando la onda exterior tiene un radio de 3m su radio aumenta a una rapidez o
							velocidad de 50 cm/seg.{" "}
						</b>
					</p>
							...
							<div class="collapse" id="collapseExplicacion">
								<div class="card card-body">
									<p>
										...
										<br />
										<b>
											a. Esquematizar el problema colocando los datos correspondiente en
											la figura.
										</b>
										<br />
										<br />
										...
										La razón de cambio de A con respecto al tiempo t se obtiene derivando
										ambos miembros en la ecuación (1) con respecto al tiempo: <br />
										<div className="explication__badge">
											<b>
												<sup>dA</sup>/<sub>dt</sub> = <sup>d</sup>/<sub>dt</sub> ( π r
												<sup>2</sup> ( t ) ) = 2 π r ( t ) (<sup>dr</sup>/<sub>dt</sub>
												)……………..…(2)
											</b>
										</div>
										...
										<div className="explication__badge">
											<b>
												El radio: r ( t ) = 3 m y la derivada del radio con respecto al
												tiempo: y <sup>dr</sup>/<sub>dt</sub> = 0.5 ms
											</b>
										</div>
										...
										<br />
										<br />
										En el instante en que el radio de la onda es de 3m, su velocidad es de
										0.5 m/seg y la velocidad de crecimiento del área del círculo que ha
										formado la onda es de 3π m2/seg o sea 9.4248 resultado obtenido
